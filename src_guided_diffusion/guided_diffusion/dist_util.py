...
#         return
#     os.environ["CUDA_VISIBLE_DEVICES"] = '0,1'#f"{MPI.COMM_WORLD.Get_rank() % GPUS_PER_NODE}" #'0,1'
...
#     os.environ["RANK"] = '0'#str(comm.rank) #'0'
#     os.environ["WORLD_SIZE"] = '1'#str(comm.size)#'1'
