...
def load_data(
    *,
    ...
    if class_cond:
        ...
        class_names =[path.split("/")[8] for path in all_files] #9 or 3
    ...
    print("I have this many images : ", len(dataset.local_images))
    if deterministic:
        loader = DataLoader(
    ...
    while True:
        yield from loader   #this is an infinite loop, it restarts once the samples end 
