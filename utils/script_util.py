...
Several changes and extensions were added. 
"""
...
def create_model(
    ...
    if dataset=='brats':
      print("I have the brats dataset")
      print('singlecontrast', single_contrast)
      number_in_channels=4
      if single_contrast:
        print("I am using a single contrst model. I will only use the FLAIR channel")
...
def create_classifier(
    ...
    return EncoderUNetModel(
        ...
        out_channels=2,#change right now to try to see how it would work for regression it was 2, change to 1
...
def create_regressor(
    ...
    return EncoderUNetModel(
        ...
        out_channels=1, #I only need one output for the regression
